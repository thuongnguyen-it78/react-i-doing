...
function Mole({ active = false, loading = false, onWhack, speed, delay, points, pointsMin = 10 }) {
  ...
  const renderScore = (x, y) => {
    ...
    document.getElementsByClassName('whac-a-mole')[0].appendChild(SCORE_HOLDER)
